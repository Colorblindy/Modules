...
function module(userid)
    ...
    if success then
        ...
        if rigtype == Enum.HumanoidRigType.R6 then
            local animationscript =  NS([[-- humanoidAnimatePlayEmote.lua
            ...
            for i,v in model.Animate:GetChildren() do
                v:Clone()
                v.Parent = animationscript
            end
            model.Animate:Destroy()
        else  
            local animationscript =  NS([[-- humanoidAnimateR15Moods.lua
